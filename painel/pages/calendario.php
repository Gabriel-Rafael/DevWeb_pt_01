<?php
    ...
    /*Nome do mês em formato de string!*/
    $nomeMes = $meses[(int)$mes - 1];

?>

<div class="box-content">
    <h2><i class="fa fa-calendar"></i> Calendário e Agenda | <u><?php echo $nomeMes ?></u>/<?php echo $ano ?></h2>
    ...
    <form method="post" action="<?php echo INCLUDE_PATH_PAINEL ?>ajax/calendario.php">
        ...
        <input type="hidden" name="data" value="2023-12-19">
